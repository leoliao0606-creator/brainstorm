...
export function normalizeIdeaGenerationPayload(payload) {
  ...
  return {
    ok: true,
    value: { language, topic, prompt, aiDivergence, generationCount, existingNotes, dismissedNotes },
  };
}
